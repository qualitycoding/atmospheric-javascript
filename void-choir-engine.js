...
(function (global) {
  ...
  var STYLES = {
    raw: {
      ...
      tremPerBeat: 4,
      archetypeWeights: { blast: 0.62, gallop: 0.30, halftime: 0.06, sparse: 0.02 },
      allowCowbell: false,
    ...
    blackgaze: {
      ...
      tremPerBeat: 4,
      archetypeWeights: { blast: 0.30, gallop: 0.34, halftime: 0.30, sparse: 0.06 },
      allowCowbell: false,
    ...
    cosmic: {
      ...
      tremPerBeat: 4,
      archetypeWeights: { blast: 0.18, gallop: 0.22, halftime: 0.40, sparse: 0.20 },
      allowCowbell: false,
  ...
  function pickArchetype(style, rng) {
    var r = rng(), acc = 0, keys = ['blast', 'gallop', 'halftime', 'sparse'];
  ...
  /* ================= VOICES ================= */
  function guitarPick(ctx, chain, t, o) {
