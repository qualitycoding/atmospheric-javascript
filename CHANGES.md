...
`void-choir.html` is still a single file (open it from disk). `void-choir-engine.js`
...
## Build
`void-choir.html` is now generated by `build.js` from `void-choir.template.html` (the interface, previously not
